    ...
    >
      ...
      <div style={{ display: 'flex', alignItems: 'flex-start', gap: '12px', padding: '16px 16px 12px' }}>
        ...
        <div style={{
          ...
          <span style={{ fontSize: '8px', color: 'var(--text4)', marginTop: '1px', letterSpacing: '0.4px' }}>
            {exchange}
          </span>
        </div>
      </div>
      ...
      {/* Trade block */}
      <div style={{ margin: '0 16px 12px', borderRadius: '10px', padding: '12px 14px', ...BLOCK_STYLE[post.direction] }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: isMobile ? 'repeat(2, 1fr)' : 'repeat(4, 1fr)', gap: '5px' }}>
          {[
            ...
            <div key={label} style={{
              ...
              <span style={{ fontSize: '8px', fontWeight: 700, letterSpacing: '1px', color: 'var(--text4)', textTransform: 'uppercase', marginBottom: '3px' }}>
                {label}
              </span>
              <span style={{ fontFamily: 'JetBrains Mono, monospace', fontSize: '13px', fontWeight: 700, lineHeight: 1, color }}>
                {value}
              </span>
            </div>
          ))}
      ...
      <div style={{ margin: '0 16px 12px' }}>
        ...
        {(!isMobile || thesisOpen) && [
          ...
          <div key={label} style={{ display: 'flex', gap: '8px', padding: '5px 0', borderBottom: i < arr.length - 1 ? '1px solid var(--border2)' : 'none' }}>
            ...
            <div style={{ flex: 1 }}>
              <div style={{ fontSize: '9px', fontWeight: 700, letterSpacing: '0.8px', color: 'var(--text4)', textTransform: 'uppercase', marginBottom: '2px' }}>
                {label}
              </div>
      ...
      <a
        ...
        style={{ margin: '0 16px 12px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', background: 'var(--surface2)', border: '1px solid var(--border)', borderRadius: '7px', padding: '8px 12px', textDecoration: 'none', transition: 'all 0.15s' }}
